...
pub mod expr_fn {
    ...
    /// Extracts the given group for a regular expression match in a string.
    pub fn regexp_extract(values: Expr, regex: Expr, idx: Expr) -> Expr {
        let args = vec![values, regex, idx];
